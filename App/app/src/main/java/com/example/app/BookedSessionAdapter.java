...
public class BookedSessionAdapter extends RecyclerView.Adapter<BookedSessionAdapter.MyViewHolder> {
    ...
    public BookedSessionAdapter(Context ct, String s1[], String s2[], String s3[], String s4[], int[] sessionId, int coachId[], String game[]){
        context = ct;
        data1 = s1;
        data2 = s2;
        data3 = s3;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.my_row_booked, parent, false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            name = itemView.findViewById(R.id.my_row_booked_name);
            date = itemView.findViewById(R.id.my_row_booked_date);
            startTime = itemView.findViewById(R.id.my_row_booked_startTime);
            //endTime = itemView.findViewById(R.id.my_row_endTime);

            coachImage = itemView.findViewById(R.id.booked_coachImage);

            constraintLayout = itemView.findViewById(R.id.my_row_booked);

            gameImage = itemView.findViewById(R.id.booked_gameImage);
        }
    }
}
